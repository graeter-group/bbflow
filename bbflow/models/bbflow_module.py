...
class BBFlowModule(FlowModule):
    ...
    def __init__(self, cfg, folding_cfg=None):
        ...
        assert total_samples_per_valid_prot % num_ranks == 0, f"Samples per valid protein ({total_samples_per_valid_prot}) must be divisible by the number of ranks ({num_ranks})"
